...
from src.auth.schemas.user_schema import (
    ...
    UserCreateRetrieveSchema
)
import re
from sqlalchemy.orm import Session

from src.auth.services.user_service import create_user
...
def create_actor_handler(body: UserCreateSchema,
...
@router.get("/get_db_params")
def data_actor_validated() -> dict:
    return {
        "DB_PORT": DB_PORT,
        "DB_USER": DB_HOST,
    }
